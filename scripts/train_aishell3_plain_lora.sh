...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/output/moss_tts_nano_sft_plain_lora}"
...
echo "[train-plain-lora] repo_root=${REPO_ROOT}"
echo "[train-plain-lora] raw_jsonl=${RAW_JSONL}"
echo "[train-plain-lora] prepared_jsonl=${PREPARED_JSONL}"
echo "[train-plain-lora] output_dir=${OUTPUT_DIR}"
