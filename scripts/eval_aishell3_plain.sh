...
CHECKPOINT="${CHECKPOINT:-${REPO_ROOT}/output/moss_tts_nano_sft_plain/checkpoint-last}"
...
TEST_OUTPUT_DIR="${TEST_OUTPUT_DIR:-${REPO_ROOT}/output/aishell3_plain_test_eval}"
...
echo "[eval-plain] checkpoint=${CHECKPOINT}"
echo "[eval-plain] running test evaluation"
