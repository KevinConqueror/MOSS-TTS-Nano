...
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_ROOT}/output/decoding_ablation/plain_entropy}"
...
run_eval() {
  ...
  echo "[plain-entropy-ablation] config=${config_path}"
  echo "[plain-entropy-ablation] output=${output_dir}"
...
run_eval "entropy_aware_decoding.yaml" "entropy_v1"
run_eval "entropy_aware_decoding_v2.yaml" "entropy_v2"
run_eval "entropy_aware_decoding_v2_hysteresis.yaml" "entropy_v2_hysteresis"
run_eval "entropy_aware_decoding_v3_gentle.yaml" "entropy_v3_gentle"
run_eval "entropy_aware_decoding_v3_gentle_hysteresis.yaml" "entropy_v3_gentle_hysteresis"
run_eval "entropy_aware_decoding_v4_focus.yaml" "entropy_v4_focus"
run_eval "entropy_triggered_short_horizon_branching.yaml" "entropy_branching"
